...
import com.pccw.app.service.mapper.UserMapper;
...
class UserResourceIT {
    ...
    public static void deleteEntities(EntityManager em) {
        try {
            em.deleteAll("app_user_authority").block();
