...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.pccw.app.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.pccw.app.security.DomainUserDetailsService", "createSpringSecurityUser");
